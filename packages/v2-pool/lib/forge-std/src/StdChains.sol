...
abstract contract StdChains {
    ...
    function setChain(string memory chainAlias, Chain memory chain) internal virtual {
        require(bytes(chainAlias).length != 0, "StdChains setChain(string,Chain): Chain alias cannot be the empty string.");
        ...
        require(
            ...
            string(abi.encodePacked("StdChains setChain(string,Chain): Chain ID ", vm.toString(chain.chainId), ' already used by "', foundAlias, '".'))
        );
    ...
    function initialize() private {
        ...
        setChainWithDefaultRpcUrl("mainnet", Chain("Mainnet", 1, "https://mainnet.infura.io/v3/6770454bc6ea42c58aac12978531b93f"));
        setChainWithDefaultRpcUrl("goerli", Chain("Goerli", 5, "https://goerli.infura.io/v3/6770454bc6ea42c58aac12978531b93f"));
        setChainWithDefaultRpcUrl("sepolia", Chain("Sepolia", 11155111, "https://sepolia.infura.io/v3/6770454bc6ea42c58aac12978531b93f"));
        ...
        setChainWithDefaultRpcUrl("arbitrum_one_goerli", Chain("Arbitrum One Goerli", 421613, "https://goerli-rollup.arbitrum.io/rpc"));
        ...
        setChainWithDefaultRpcUrl("avalanche_fuji", Chain("Avalanche Fuji", 43113, "https://api.avax-test.network/ext/bc/C/rpc"));
